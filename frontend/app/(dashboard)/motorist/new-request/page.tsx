...
const steps = [
  ...
  { id: 2, title: 'Description', icon: eamera },
...
export default function NewRequestPage() {
  ...
  const handleGetLocation = () => {
    if (navigator.geolocation) {
      ...
      toast.error('La geolocalisation n\'est pas supportee');
    }
  };
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {currentStep === 0 && (
            <Card>
              <CardHeader>
                <CardTitle>Ou etes-vous ?</CardTitle>
                <CardDescription>
                  Nous avons besoin de votre position pour trouver les garages à proximite
                </CardDescription>
              </CardHeader>
                  ...
                  <div className="space-y-4">
                    ...
                    {isLoadingGarages ? (
                      ...
                      <div className="space-y-2">
                        <Label>Garages à proximite</Label>
                      ...
                      <p className="text-center text-muted-foreground py-4">
                        Aucun garage trouve à proximite
                      </p>
                    )}
                  </div>
                )}
          ...
          {currentStep === 1 && (
            <Card>
              <CardHeader>
                <CardTitle>Quel vehicule ?</CardTitle>
                <CardDescription>
                  Selectionnez le vehicule concerne (optionnel)
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {vehicles.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <Button variant="outline" asChild>
                      <a href="/motorist/vehicles/new">Ajouter un vehicule</a>
                    </Button>
                  </div>
                )}
              </CardContent>
          ...
          {currentStep === 2 && (
            <Card>
              <CardHeader>
                <CardTitle>Decrivez votre panne</CardTitle>
                <CardDescription>
                  Plus vous donnez de details, mieux le garagiste pourra vous aider
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
          ...
          {currentStep === 3 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Verifiez les informations avant d'envoyer
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
